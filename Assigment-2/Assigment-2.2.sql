...
left join postal_address pa on pa.CONTACT_MECH_ID=ocm.CONTACT_MECH_ID where ocm.CONTACT_MECH_PURPOSE_TYPE_ID="SHIPPING_LOCATION" and pa.STATE_PROVINCE_GEO_ID="NY";